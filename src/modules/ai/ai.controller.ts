...
export class AIController {
  ...
  async chatCooperative(@Body('message') message: string) {
    this.logger.log(
      `🤖 AI CONTROLLER: Incoming Request POST /ai/chat. Message: "${message}"`,
    );
    if (!message) {
      this.logger.warn(
        `🤖 AI CONTROLLER: Request validation failed. Message is empty.`,
      );
    ...
    try {
      ...
      this.logger.log(
        `🤖 AI CONTROLLER: Success response generated for /ai/chat.`,
      );
      return { success: true, data: response, response: response };
    } catch (err: any) {
      this.logger.error(
        `🤖 AI CONTROLLER: Error in /ai/chat: ${err.message}`,
        err.stack,
      );
      throw err;
    }
  ...
  async chatManagement(@Body('message') message: string) {
    this.logger.log(
      `🤖 AI CONTROLLER: Incoming Request POST /ai/management. Message: "${message}"`,
    );
    if (!message) {
      this.logger.warn(
        `🤖 AI CONTROLLER: Request validation failed. Message is empty.`,
    ...
    try {
      ...
      this.logger.log(
        `🤖 AI CONTROLLER: Success response generated for /ai/management.`,
      );
      return { success: true, data: response, response: response };
    } catch (err: any) {
      this.logger.error(
        `🤖 AI CONTROLLER: Error in /ai/management: ${err.message}`,
        err.stack,
      );
      throw err;
    }
  ...
  async analyzeCommunityDemands() {
    ...
    try {
      ...
      this.logger.log(
        `🤖 AI CONTROLLER: Success response generated for /ai/community.`,
      );
      return { success: true, data: response, response: response };
    } catch (err: any) {
      this.logger.error(
        `🤖 AI CONTROLLER: Error in /ai/community: ${err.message}`,
        err.stack,
      );
      throw err;
    }
  ...
  async getInventoryReplenishmentOptions() {
    ...
    try {
      ...
      this.logger.log(
        `🤖 AI CONTROLLER: Success response generated for /ai/inventory.`,
      );
      return { success: true, data: response, response: response };
    } catch (err: any) {
      this.logger.error(
        `🤖 AI CONTROLLER: Error in /ai/inventory: ${err.message}`,
        err.stack,
      );
      throw err;
    }
  ...
  async detectInventoryAnomalies() {
    ...
    try {
      ...
      this.logger.log(
        `🤖 AI CONTROLLER: Success response generated for /ai/anomaly.`,
      );
      return { success: true, data: response, response: response };
    } catch (err: any) {
      this.logger.error(
        `🤖 AI CONTROLLER: Error in /ai/anomaly: ${err.message}`,
        err.stack,
      );
      throw err;
    }
  ...
  async chatUMKM(@Req() req: any, @Body('message') message: string) {
    this.logger.log(
      `🤖 AI CONTROLLER: Incoming Request POST /ai/umkm from user ${req.user.id}`,
    );
    if (!message) {
      return { success: false, error: 'Message content is required' };
    }
    try {
      const response = await this.aiService.chatUMKMAssistant(
        req.user.id,
        message,
      );
      ...
      this.logger.error(
        `🤖 AI CONTROLLER: Error in /ai/umkm: ${err.message}`,
        err.stack,
      );
      throw err;
    }
  ...
  async getExecutiveDashboard() {
    this.logger.log(
      `🤖 AI CONTROLLER: Incoming Request GET /ai/executive-dashboard.`,
    );
    try {
      ...
      this.logger.error(
        `🤖 AI CONTROLLER: Error in /ai/executive-dashboard: ${err.message}`,
        err.stack,
      );
      throw err;
    }
  ...
  @RequirePermissions(Permission.AI_EXECUTIVE)
  async seedKnowledgeBase() {
    this.logger.log(
      `🤖 AI CONTROLLER: Incoming Request POST /ai/seed-knowledge.`,
    );
    try {
      ...
      return {
        success: true,
        message: 'Knowledge base seeded with base documents successfully!',
      };
    } catch (err: any) {
      this.logger.error(
        `🤖 AI CONTROLLER: Error in /ai/seed-knowledge: ${err.message}`,
        err.stack,
      );
      throw err;
    }
