...
let AIService = AIService_1 = class AIService {
    ...
    async chatUMKMAssistant(userId, message) {
        try {
            ...
            if (!umkm) {
                throw new common_1.BadRequestException('Profil UMKM tidak ditemukan');
            }
    ...
    async getExecutiveDashboardSummary() {
        try {
            const [lowStockProductsCount, totalSuggestionsCount, topSuggestions, anomalyResults, totalOrdersCount,] = await Promise.all([
